...
//     expect(handled.id).toEqual(blakejs.blake2bHex(vcJwtSecp256k1))
...
//     const handled = await handler.handle(message, context)
//     expect(handled.isValid()).toEqual(true)
//     expect(handled.id).toEqual(blakejs.blake2bHex(vpJwtSecp256k1))
...
//     const handled = await handler.handle(message, context)
//     expect(handled.isValid()).toEqual(true)
//     expect(handled.id).toEqual(blakejs.blake2bHex(vcJwtEd25519))
...
//     const handled = await handler.handle(message, context)
//     expect(handled.isValid()).toEqual(true)
//     expect(handled.id).toEqual(blakejs.blake2bHex(vpJwtEd25519))
...
//     const handled = await handler.handle(message, context)
//     expect(handled.isValid()).toEqual(true)
//     expect(handled.id).toEqual(blakejs.blake2bHex(vpMultiAudJwt))
...
//     expect(handled.isValid()).toEqual(true)
//     expect(handled.id).toEqual(blakejs.blake2bHex(token))
