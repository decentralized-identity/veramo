import { IDIDCommTransport, IDIDCommTransportResult } from "./transports.js"
 ...
 */
 export class DIDCommHttpTransport implements IDIDCommTransport {
    id: string
     ...
     * section.
     */
    constructor(httpMethod?: 'post' | 'get', id?: string) {
      this.id = id || uuidv4()
