...
import { TAgent, CredentialPayload, ICredentialIssuer, IIdentifier, VerifiableCredential, VerifiablePresentation } from '@veramo/core-types'
...
const database_test = path.normalize(path.resolve() + '\\packages\\credential-bbs\\src\\__tests__\\data\\database_test.sqlite')
