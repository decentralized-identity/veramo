...
export class PeerDIDProvider extends AbstractIdentifierProvider {
  ...
  async createIdentifier(
    ...
    if (options.num_algo == 0) {
      ...
      const methodSpecificId = bytesToMultibase(hexToBytes(key.publicKeyHex), "Ed25519")
      ...
      const authKeyText = bytesToMultibase(hexToBytes(authKey.publicKeyHex), "Ed25519")      
      const agreementKeyText = bytesToMultibase(hexToBytes(agreementKey.publicKeyHex), "X25519")
