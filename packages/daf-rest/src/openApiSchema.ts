  ...
  components: {
    schemas: {
      ...
      LinkedDataProof: {
        ...
        required: ['type', 'created', 'creator', 'nonce', 'signatureValue'],
        additionalProperties: false,
      },
      IMessage: {
        type: 'object',
      ...
      'Verifiable-W3CPresentation': {
        ...
        required: ['@context', 'holder', 'proof', 'type', 'verifiableCredential', 'verifier'],
      },
      ...
      IIdentity: {
        ...
        required: ['did', 'provider', 'controllerKeyId', 'keys', 'services'],
        additionalProperties: false,
      },
      ...
      TCredentialColumns: {
        type: 'string',
        enum: ['context', 'type', 'id', 'issuer', 'subject', 'expirationDate', 'issuanceDate'],
      },
      ...
      TPresentationColumns: {
        type: 'string',
        enum: ['context', 'type', 'id', 'holder', 'verifier', 'expirationDate', 'issuanceDate'],
      },
      ...
      W3CPresentation: {
        ...
        required: ['@context', 'holder', 'type', 'verifiableCredential', 'verifier'],
        description:
