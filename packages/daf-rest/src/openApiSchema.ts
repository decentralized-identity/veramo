  ...
  "components": {
    "schemas": {
              ...
              "allOf": [
                {
                  "allOf": [
                    {
                      "$ref": "#/components/schemas/Pick<FixedCredentialPayload,\"id\"|\"credentialSubject\"|\"credentialStatus\">"
                    },
                    {
              ...
              "allOf": [
                {
                  "allOf": [
                    {
                      "$ref": "#/components/schemas/Pick<FixedPresentationPayload,\"id\"|\"issuanceDate\"|\"expirationDate\"|\"holder\">"
                    },
                    {
      ...
      "IGetVerifiableCredentialsForSdrArgs": {
        ...
        "properties": {
          "sdr": {
            "$ref": "#/components/schemas/Pick<ISelectiveDisclosureRequest,\"replyUrl\"|\"subject\"|\"tag\"|\"claims\"|\"credentials\">"
          },
          "did": {
            "type": "string"
          }
